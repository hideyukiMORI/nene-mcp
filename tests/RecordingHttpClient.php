...
final class RecordingHttpClient implements McpHttpClientInterface
{
    ...
    {
        $this->requests[] = ['GET', $baseUrl, $path];
    ...
    {
        $this->requests[] = ['POST', $baseUrl, $path];
    ...
    {
        $this->requests[] = ['PUT', $baseUrl, $path];
    ...
    {
        $this->requests[] = ['PATCH', $baseUrl, $path];
    ...
    {
        $this->requests[] = ['DELETE', $baseUrl, $path];
