# Field Trial 496 — NeNe Docker golden path smoke + base URL without scheme (L9)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 496`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **NeNe Docker golden path smoke + base URL without scheme (L9)**.
...
Automated FT496 (NeNe Docker golden path smoke + base URL without scheme (L9)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT497
