# Field Trial 673 — Misconfiguration adversarial + create/read round-trip (L15)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 673`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Misconfiguration adversarial + create/read round-trip (L15)**.
...
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"createTodo\",\n    \"operationId\": \"createTodo\",\n    \"statusCode\": 200,\n    \"requestId\": \"08c8ed33ef5a064605df8da2d63455de\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"success\",\n            \"errorCode\": \"\",\n            \"todo\": {\n                \"id\": 72,\n                \"user_id\": 1,\n                \"title\": \"FT630 L14 write\",\n                \"is_completed\": false,\n                \"created_at\": \"2026-05-22 15:58:42\",\n                \"updated_at\": \"2026-05-22 15:58:42\"\n            }\n        }\n    }\n}"}],"structuredContent":{"tool":"createTodo","operationId":"createTodo","statusCode":200,"requestId":"08c8ed33ef5a064605df8da2d63455de","body":{"Result":true,"Data":{"status":"success","errorCode":"","todo":{"id":72,"user_id":1,"title":"FT630 L14 write","is_completed":false,"created_at":"2026-05-22 15:58:42","updated_at":"2026-05-22 15:58:42"}}}},"isError":false}}
ADV-PASS Bearer createTodo without CSRF

# L15 probe (FT660+, Bearer+operator composite, variant 1)
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"createTodo\",\n    \"operationId\": \"createTodo\",\n    \"statusCode\": 200,\n    \"requestId\": \"697e5d4f5986eef9d510cb1fe2d42b93\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"success\",\n            \"errorCode\": \"\",\n            \"todo\": {\n                \"id\": 73,\n                \"user_id\": 1,\n                \"title\": \"L15 roundtrip\",\n                \"is_completed\": false,\n                \"created_at\": \"2026-05-22 15:58:42\",\n                \"updated_at\": \"2026-05-22 15:58:42\"\n            }\n        }\n    }\n}"}],"structuredContent":{"tool":"createTodo","operationId":"createTodo","statusCode":200,"requestId":"697e5d4f5986eef9d510cb1fe2d42b93","body":{"Result":true,"Data":{"status":"success","errorCode":"","todo":{"id":73,"user_id":1,"title":"L15 roundtrip","is_completed":false,"created_at":"2026-05-22 15:58:42","updated_at":"2026-05-22 15:58:42"}}}},"isError":false}}
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"getTodoById\",\n    \"operationId\": \"getTodo\",\n    \"statusCode\": 200,\n    \"requestId\": \"84336019a1396f709562a7efe5615f17\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"success\",\n            \"errorCode\": \"\",\n            \"todo\": {\n                \"id\": 73,\n                \"user_id\": 1,\n                \"title\": \"L15 roundtrip\",\n                \"is_completed\": false,\n                \"created_at\": \"2026-05-22 15:58:42\",\n                \"updated_at\": \"2026-05-22 15:58:42\"\n            }\n        }\n    }\n}"}],"structuredContent":{"tool":"getTodoById","operationId":"getTodo","statusCode":200,"requestId":"84336019a1396f709562a7efe5615f17","body":{"Result":true,"Data":{"status":"success","errorCode":"","todo":{"id":73,"user_id":1,"title":"L15 roundtrip","is_completed":false,"created_at":"2026-05-22 15:58:42","updated_at":"2026-05-22 15:58:42"}}}},"isError":false}}
ADV-PASS create/read round-trip id_73
```
...
N/A — security review scheduled for FT675.
...
Automated FT673 (Misconfiguration adversarial + create/read round-trip (L15)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT674
