# Field Trial 555 — Catalog edge cases + invalid log value (L11)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 555`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Catalog edge cases + invalid log value (L11)**.
...
Automated FT555 (Catalog edge cases + invalid log value (L11)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT556
