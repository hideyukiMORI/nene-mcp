# Field Trial 255 — Catalog edge cases + Query/base URL confusion (L6)
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 255`
...
Automated FT255 (Catalog edge cases + Query/base URL confusion (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT256
