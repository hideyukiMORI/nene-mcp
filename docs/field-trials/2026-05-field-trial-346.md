# Field Trial 346 — NeNe Docker golden path smoke + JSON-RPC fuzz (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 346`
...
N/A — security review scheduled for FT348.
...
Automated FT346 (NeNe Docker golden path smoke + JSON-RPC fuzz (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT347
