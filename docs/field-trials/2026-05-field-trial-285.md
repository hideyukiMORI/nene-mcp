# Field Trial 285 — Catalog edge cases + NeNe CSRF write re-attack (L6)
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 285`
...
Automated FT285 (Catalog edge cases + NeNe CSRF write re-attack (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT286
