# Field Trial 600 — Packagist install regression + stderr HTTP log line (L13)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 600`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Packagist install regression + stderr HTTP log line (L13)**.
...
Automated FT600 (Packagist install regression + stderr HTTP log line (L13)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT601
