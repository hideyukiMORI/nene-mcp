# Field Trial 343 — Misconfiguration adversarial + Query/base URL confusion (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 343`
...
Automated FT343 (Misconfiguration adversarial + Query/base URL confusion (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT344
