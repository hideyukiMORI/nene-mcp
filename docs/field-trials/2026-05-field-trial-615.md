# Field Trial 615 — Catalog edge cases + catalog env precedence (L13)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 615`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Catalog edge cases + catalog env precedence (L13)**.
...
Automated FT615 (Catalog edge cases + catalog env precedence (L13)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT616
