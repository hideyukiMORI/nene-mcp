# Field Trial 400 — Packagist install regression + SSRF off-host escape (L6)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 400`
...
N/A — security review scheduled for FT402.
...
Automated FT400 (Packagist install regression + SSRF off-host escape (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT401
