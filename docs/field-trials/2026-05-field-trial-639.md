# Field Trial 639 — Security review — catalog probes + about bearer flag no leak (L14)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 639`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Security review — catalog probes + about bearer flag no leak (L14)**.
...
Automated FT639 (Security review — catalog probes + about bearer flag no leak (L14)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT640
