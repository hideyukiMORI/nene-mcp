# Field Trial 368 — Combined smoke milestone + SSRF off-host escape (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 368`
...
Automated FT368 (Combined smoke milestone + SSRF off-host escape (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT369
