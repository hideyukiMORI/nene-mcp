# Field Trial 326 — NeNe Docker golden path smoke + Catalog safety mislabel (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 326`
...
N/A — security review scheduled for FT327.
...
Automated FT326 (NeNe Docker golden path smoke + Catalog safety mislabel (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT327
