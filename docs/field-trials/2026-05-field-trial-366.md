# Field Trial 366 — NeNe Docker golden path smoke + Catalog safety mislabel (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 366`
...
Automated FT366 (NeNe Docker golden path smoke + Catalog safety mislabel (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT367
