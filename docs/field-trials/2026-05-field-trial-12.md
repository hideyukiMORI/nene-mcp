# Field Trial 12 — Security milestone — write surface
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 12`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Security milestone — write surface**.
...
Automated FT12 (Security milestone — write surface): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT13
