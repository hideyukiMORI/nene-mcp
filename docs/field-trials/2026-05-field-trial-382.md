# Field Trial 382 — About-only minimal install + Catalog safety mislabel (L6)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 382`
...
Automated FT382 (About-only minimal install + Catalog safety mislabel (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT383
