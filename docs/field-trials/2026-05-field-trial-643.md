# Field Trial 643 — Misconfiguration adversarial + Bearer createTodo regression (L14)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 643`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Misconfiguration adversarial + Bearer createTodo regression (L14)**.
...
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"getTodoById\",\n    \"operationId\": \"getTodo\",\n    \"statusCode\": 401,\n    \"requestId\": \"95281d7fc96d1f890b703212afa94e80\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"failure\",\n            \"errorCode\": \"SESSION-CLOSED\",\n            \"errorMessage\": \"Session timeout. Please log in again.\"\n        }\n    }\n}"}],"structuredContent":{"tool":"getTodoById","operationId":"getTodo","statusCode":401,"requestId":"95281d7fc96d1f890b703212afa94e80","body":{"Result":true,"Data":{"status":"failure","errorCode":"SESSION-CLOSED","errorMessage":"Session timeout. Please log in again."}}},"isError":true}}
...
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"createTodo\",\n    \"operationId\": \"createTodo\",\n    \"statusCode\": 200,\n    \"requestId\": \"4e143b0a15424b8ad4cda6ed5e4debfc\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"success\",\n            \"errorCode\": \"\",\n            \"todo\": {\n                \"id\": 55,\n                \"user_id\": 1,\n                \"title\": \"FT630 L14 write\",\n                \"is_completed\": false,\n                \"created_at\": \"2026-05-22 15:51:02\",\n                \"updated_at\": \"2026-05-22 15:51:02\"\n            }\n        }\n    }\n}"}],"structuredContent":{"tool":"createTodo","operationId":"createTodo","statusCode":200,"requestId":"4e143b0a15424b8ad4cda6ed5e4debfc","body":{"Result":true,"Data":{"status":"success","errorCode":"","todo":{"id":55,"user_id":1,"title":"FT630 L14 write","is_completed":false,"created_at":"2026-05-22 15:51:02","updated_at":"2026-05-22 15:51:02"}}}},"isError":false}}
...
Automated FT643 (Misconfiguration adversarial + Bearer createTodo regression (L14)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT644
