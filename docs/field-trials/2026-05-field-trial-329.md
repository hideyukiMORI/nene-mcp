# Field Trial 329 — Security review — catalog probes + Bearer bypass / empty token (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 329`
...
N/A — security review scheduled for FT330.
...
Automated FT329 (Security review — catalog probes + Bearer bypass / empty token (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT330
