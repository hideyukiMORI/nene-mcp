# Field Trial 17 — Agent-only MCP surface
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 17`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Agent-only MCP surface**.
...
Automated FT17 (Agent-only MCP surface): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT18
