# Field Trial 610 — Packagist install regression + write fail-closed + timeout (L13)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 610`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Packagist install regression + write fail-closed + timeout (L13)**.
...
N/A — security review scheduled for FT612.
...
Automated FT610 (Packagist install regression + write fail-closed + timeout (L13)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT611
