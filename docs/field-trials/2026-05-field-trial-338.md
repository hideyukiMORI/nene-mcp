# Field Trial 338 — Combined smoke milestone + JSON-RPC fuzz (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 338`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Combined smoke milestone + JSON-RPC fuzz (L6)**.
...
N/A — security review scheduled for FT339.
...
Automated FT338 (Combined smoke milestone + JSON-RPC fuzz (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT339
