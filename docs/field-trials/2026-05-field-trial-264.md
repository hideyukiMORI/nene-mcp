# Field Trial 264 — Write fail-closed regression + SSRF off-host escape (L6)
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 264`
...
Automated FT264 (Write fail-closed regression + SSRF off-host escape (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT265
