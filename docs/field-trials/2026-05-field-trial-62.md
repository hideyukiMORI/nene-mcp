# Field Trial 62 — About-only minimal install
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 62`
...
N/A — security review scheduled for FT63.
...
Automated FT62 (About-only minimal install): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT63
