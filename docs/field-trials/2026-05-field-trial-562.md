# Field Trial 562 — About-only minimal install + empty TLS CA path (L11)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 562`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **About-only minimal install + empty TLS CA path (L11)**.
...
Automated FT562 (About-only minimal install + empty TLS CA path (L11)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT563
