# Field Trial 559 — Security review — catalog probes + timeout max boundary (L11)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 559`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Security review — catalog probes + timeout max boundary (L11)**.
...
Automated FT559 (Security review — catalog probes + timeout max boundary (L11)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT560
