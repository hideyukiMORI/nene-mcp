# Field Trial 689 — Security review — catalog probes + sessionLogin fail-closed (L15)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 689`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Security review — catalog probes + sessionLogin fail-closed (L15)**.
...
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"listTodos\",\n    \"operationId\": \"listTodos\",\n    \"statusCode\": 401,\n    \"requestId\": \"2a029917cb01d16d9533e87d2999269b\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"failure\",\n            \"errorCode\": \"SESSION-CLOSED\",\n            \"errorMessage\": \"Session timeout. Please log in again.\"\n        }\n    }\n}"}],"structuredContent":{"tool":"listTodos","operationId":"listTodos","statusCode":401,"requestId":"2a029917cb01d16d9533e87d2999269b","body":{"Result":true,"Data":{"status":"failure","errorCode":"SESSION-CLOSED","errorMessage":"Session timeout. Please log in again."}}},"isError":true}}
...
Automated FT689 (Security review — catalog probes + sessionLogin fail-closed (L15)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT690
