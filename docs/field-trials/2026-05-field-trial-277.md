# Field Trial 277 — Fresh clone bootstrap + NeNe CSRF write re-attack (L6)
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 277`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Fresh clone bootstrap + NeNe CSRF write re-attack (L6)**.
...
N/A — security review scheduled for FT279.
...
Automated FT277 (Fresh clone bootstrap + NeNe CSRF write re-attack (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT278
