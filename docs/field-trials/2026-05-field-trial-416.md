# Field Trial 416 — NeNe Docker golden path smoke + SSRF off-host escape (L6)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 416`
...
Automated FT416 (NeNe Docker golden path smoke + SSRF off-host escape (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT417
