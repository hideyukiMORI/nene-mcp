# Field Trial 398 — Combined smoke milestone + Catalog safety mislabel (L6)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 398`
...
Automated FT398 (Combined smoke milestone + Catalog safety mislabel (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT399
