# Field Trial 499 — Security review — catalog probes + oversized Bearer token (L9)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 499`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Security review — catalog probes + oversized Bearer token (L9)**.
...
Automated FT499 (Security review — catalog probes + oversized Bearer token (L9)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT500
