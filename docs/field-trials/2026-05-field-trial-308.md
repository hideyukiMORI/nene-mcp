# Field Trial 308 — Combined smoke milestone + Secret leak probe (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 308`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Combined smoke milestone + Secret leak probe (L6)**.
...
N/A — security review scheduled for FT309.
...
Automated FT308 (Combined smoke milestone + Secret leak probe (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT309
