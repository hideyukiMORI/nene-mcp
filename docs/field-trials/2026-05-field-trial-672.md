# Field Trial 672 — About-only minimal install + unicode Bearer write (L15)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 672`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **About-only minimal install + unicode Bearer write (L15)**.
...
Automated FT672 (About-only minimal install + unicode Bearer write (L15)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT673
