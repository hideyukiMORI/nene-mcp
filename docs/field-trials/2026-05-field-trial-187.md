# Field Trial 187 — Fresh clone bootstrap
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 187`
...
Automated FT187 (Fresh clone bootstrap): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT188
