# Field Trial 535 — Catalog edge cases + invalid timeout fallback (L10)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 535`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Catalog edge cases + invalid timeout fallback (L10)**.
...
Automated FT535 (Catalog edge cases + invalid timeout fallback (L10)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT536
