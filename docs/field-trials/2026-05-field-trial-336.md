# Field Trial 336 — NeNe Docker golden path smoke + SSRF off-host escape (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 336`
...
Automated FT336 (NeNe Docker golden path smoke + SSRF off-host escape (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT337
