# Field Trial 288 — Combined smoke milestone + SSRF off-host escape (L6)
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 288`
...
Automated FT288 (Combined smoke milestone + SSRF off-host escape (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT289
