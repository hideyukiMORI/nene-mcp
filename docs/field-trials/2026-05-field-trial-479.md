# Field Trial 479 — Security review — catalog probes + invalid JSON-RPC version (L8)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 479`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Security review — catalog probes + invalid JSON-RPC version (L8)**.
...
Automated FT479 (Security review — catalog probes + invalid JSON-RPC version (L8)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT480
