# Field Trial 266 — NeNe Docker golden path smoke + JSON-RPC fuzz (L6)
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 266`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **NeNe Docker golden path smoke + JSON-RPC fuzz (L6)**.
...
N/A — security review scheduled for FT267.
...
Automated FT266 (NeNe Docker golden path smoke + JSON-RPC fuzz (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT267
