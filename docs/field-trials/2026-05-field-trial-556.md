# Field Trial 556 — NeNe Docker golden path smoke + empty TLS CA path (L11)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 556`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **NeNe Docker golden path smoke + empty TLS CA path (L11)**.
...
N/A — security review scheduled for FT558.
...
Automated FT556 (NeNe Docker golden path smoke + empty TLS CA path (L11)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT557
