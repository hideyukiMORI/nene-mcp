# Field Trial 289 — Security review — catalog probes + Bearer bypass / empty token (L6)
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 289`
...
N/A — security review scheduled for FT291.
...
Automated FT289 (Security review — catalog probes + Bearer bypass / empty token (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT290
