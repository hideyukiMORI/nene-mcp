# Field Trial 415 — Catalog edge cases + Query/base URL confusion (L6)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 415`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Catalog edge cases + Query/base URL confusion (L6)**.
...
N/A — security review scheduled for FT417.
...
Automated FT415 (Catalog edge cases + Query/base URL confusion (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT416
