# Field Trial 372 — About-only minimal install + Secret leak probe (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 372`
...
Automated FT372 (About-only minimal install + Secret leak probe (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT373
