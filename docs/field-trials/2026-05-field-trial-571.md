# Field Trial 571 — Multi-tool read catalog + NENE2 catalog alias (L12)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 571`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Multi-tool read catalog + NENE2 catalog alias (L12)**.
...
Automated FT571 (Multi-tool read catalog + NENE2 catalog alias (L12)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT572
