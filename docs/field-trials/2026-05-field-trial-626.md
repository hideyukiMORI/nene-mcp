# Field Trial 626 — NeNe Docker golden path smoke + negative timeout fallback (L13)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 626`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **NeNe Docker golden path smoke + negative timeout fallback (L13)**.
...
{"jsonrpc":"2.0","id":1,"error":{"code":-32603,"message":"MCP tool catalog could not be read from \"/tmp/ft-l8-626/bad.json}\"."}}
...
N/A — security review scheduled for FT627.
...
Automated FT626 (NeNe Docker golden path smoke + negative timeout fallback (L13)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT627
