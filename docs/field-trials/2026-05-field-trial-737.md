# Field Trial 737 — Fresh clone bootstrap + requestId on Bearer write (L17)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 737`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Fresh clone bootstrap + requestId on Bearer write (L17)**.
...
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"listTodos\",\n    \"operationId\": \"listTodos\",\n    \"statusCode\": 401,\n    \"requestId\": \"870784aabc976e085c46887d73fd45f2\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"failure\",\n            \"errorCode\": \"SESSION-CLOSED\",\n            \"errorMessage\": \"Session timeout. Please log in again.\"\n        }\n    }\n}"}],"structuredContent":{"tool":"listTodos","operationId":"listTodos","statusCode":401,"requestId":"870784aabc976e085c46887d73fd45f2","body":{"Result":true,"Data":{"status":"failure","errorCode":"SESSION-CLOSED","errorMessage":"Session timeout. Please log in again."}}},"isError":true}}
...
N/A — security review scheduled for FT738.
...
Automated FT737 (Fresh clone bootstrap + requestId on Bearer write (L17)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT738
