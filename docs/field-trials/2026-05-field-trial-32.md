# Field Trial 32 — About-only minimal install
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 32`
...
N/A — security review scheduled for FT33.
...
Automated FT32 (About-only minimal install): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT33
