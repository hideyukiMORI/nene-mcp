# Field Trial 628 — Combined smoke milestone + write fail-closed + timeout (L13)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 628`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Combined smoke milestone + write fail-closed + timeout (L13)**.
...
Automated FT628 (Combined smoke milestone + write fail-closed + timeout (L13)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT629
