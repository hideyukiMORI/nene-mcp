# Field Trial 410 — Packagist install regression + JSON-RPC fuzz (L6)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 410`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Packagist install regression + JSON-RPC fuzz (L6)**.
...
Automated FT410 (Packagist install regression + JSON-RPC fuzz (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT411
