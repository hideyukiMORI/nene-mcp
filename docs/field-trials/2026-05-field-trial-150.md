# Field Trial 150 — Packagist install regression
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 150`
...
Automated FT150 (Packagist install regression): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT151
