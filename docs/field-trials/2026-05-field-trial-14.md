# Field Trial 14 — Cross-platform read path
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 14`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Cross-platform read path**.
...
Automated FT14 (Cross-platform read path): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT15
