# Field Trial 544 — Write fail-closed regression + empty TLS CA path (L11)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 544`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Write fail-closed regression + empty TLS CA path (L11)**.
...
N/A — security review scheduled for FT546.
...
Automated FT544 (Write fail-closed regression + empty TLS CA path (L11)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT545
