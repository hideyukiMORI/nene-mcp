# Field Trial 679 — Security review — catalog probes + create/read round-trip (L15)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 679`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Security review — catalog probes + create/read round-trip (L15)**.
...
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"createTodo\",\n    \"operationId\": \"createTodo\",\n    \"statusCode\": 200,\n    \"requestId\": \"ffabebe19f61672f9affed1fb98cec4e\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"success\",\n            \"errorCode\": \"\",\n            \"todo\": {\n                \"id\": 76,\n                \"user_id\": 1,\n                \"title\": \"FT630 L14 write\",\n                \"is_completed\": false,\n                \"created_at\": \"2026-05-22 15:58:50\",\n                \"updated_at\": \"2026-05-22 15:58:50\"\n            }\n        }\n    }\n}"}],"structuredContent":{"tool":"createTodo","operationId":"createTodo","statusCode":200,"requestId":"ffabebe19f61672f9affed1fb98cec4e","body":{"Result":true,"Data":{"status":"success","errorCode":"","todo":{"id":76,"user_id":1,"title":"FT630 L14 write","is_completed":false,"created_at":"2026-05-22 15:58:50","updated_at":"2026-05-22 15:58:50"}}}},"isError":false}}
ADV-PASS Bearer createTodo without CSRF

# L15 probe (FT660+, Bearer+operator composite, variant 1)
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"createTodo\",\n    \"operationId\": \"createTodo\",\n    \"statusCode\": 200,\n    \"requestId\": \"a08dcf4b0f12473a7ac4a3f3278e27fa\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"success\",\n            \"errorCode\": \"\",\n            \"todo\": {\n                \"id\": 77,\n                \"user_id\": 1,\n                \"title\": \"L15 roundtrip\",\n                \"is_completed\": false,\n                \"created_at\": \"2026-05-22 15:58:50\",\n                \"updated_at\": \"2026-05-22 15:58:50\"\n            }\n        }\n    }\n}"}],"structuredContent":{"tool":"createTodo","operationId":"createTodo","statusCode":200,"requestId":"a08dcf4b0f12473a7ac4a3f3278e27fa","body":{"Result":true,"Data":{"status":"success","errorCode":"","todo":{"id":77,"user_id":1,"title":"L15 roundtrip","is_completed":false,"created_at":"2026-05-22 15:58:50","updated_at":"2026-05-22 15:58:50"}}}},"isError":false}}
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"getTodoById\",\n    \"operationId\": \"getTodo\",\n    \"statusCode\": 200,\n    \"requestId\": \"1d0bea390710367b7d876a3ac5736960\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"success\",\n            \"errorCode\": \"\",\n            \"todo\": {\n                \"id\": 77,\n                \"user_id\": 1,\n                \"title\": \"L15 roundtrip\",\n                \"is_completed\": false,\n                \"created_at\": \"2026-05-22 15:58:50\",\n                \"updated_at\": \"2026-05-22 15:58:50\"\n            }\n        }\n    }\n}"}],"structuredContent":{"tool":"getTodoById","operationId":"getTodo","statusCode":200,"requestId":"1d0bea390710367b7d876a3ac5736960","body":{"Result":true,"Data":{"status":"success","errorCode":"","todo":{"id":77,"user_id":1,"title":"L15 roundtrip","is_completed":false,"created_at":"2026-05-22 15:58:50","updated_at":"2026-05-22 15:58:50"}}}},"isError":false}}
ADV-PASS create/read round-trip id_77
```
...
N/A — security review scheduled for FT681.
...
Automated FT679 (Security review — catalog probes + create/read round-trip (L15)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT680
