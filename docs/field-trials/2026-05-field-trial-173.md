# Field Trial 173 — Misconfiguration adversarial
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 173`
...
Automated FT173 (Misconfiguration adversarial): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT174
