# Field Trial 152 — About-only minimal install
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 152`
...
N/A — security review scheduled for FT153.
...
Automated FT152 (About-only minimal install): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT153
