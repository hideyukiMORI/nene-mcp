# Field Trial 364 — Write fail-closed regression + Secret leak probe (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 364`
...
Automated FT364 (Write fail-closed regression + Secret leak probe (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT365
