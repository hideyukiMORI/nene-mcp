# Field Trial 374 — Write fail-closed regression + Catalog safety mislabel (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 374`
...
N/A — security review scheduled for FT375.
...
Automated FT374 (Write fail-closed regression + Catalog safety mislabel (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT375
