# Field Trial 605 — Catalog edge cases + HTTPS TLS CA fail-fast (L13)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 605`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Catalog edge cases + HTTPS TLS CA fail-fast (L13)**.
...
Automated FT605 (Catalog edge cases + HTTPS TLS CA fail-fast (L13)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT606
