# Field Trial 273 — Misconfiguration adversarial + Bearer bypass / empty token (L6)
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 273`
...
Automated FT273 (Misconfiguration adversarial + Bearer bypass / empty token (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT274
