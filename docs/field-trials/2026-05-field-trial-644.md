# Field Trial 644 — Write fail-closed regression + Bearer getTodoById regression (L14)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 644`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Write fail-closed regression + Bearer getTodoById regression (L14)**.
...
{"jsonrpc":"2.0","id":1,"error":{"code":-32603,"message":"MCP tool catalog could not be read from \"/tmp/ft-l8-644/bad.json}\"."}}
...
N/A — security review scheduled for FT645.
...
Automated FT644 (Write fail-closed regression + Bearer getTodoById regression (L14)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT645
