# Field Trial 613 — Misconfiguration adversarial + float timeout fallback (L13)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 613`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Misconfiguration adversarial + float timeout fallback (L13)**.
...
Automated FT613 (Misconfiguration adversarial + float timeout fallback (L13)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT614
