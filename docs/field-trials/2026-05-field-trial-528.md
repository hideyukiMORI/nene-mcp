# Field Trial 528 — Combined smoke milestone + HTTP timeout env (L10)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 528`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Combined smoke milestone + HTTP timeout env (L10)**.
...
Automated FT528 (Combined smoke milestone + HTTP timeout env (L10)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT529
