# Field Trial 490 — Packagist install regression + base URL without scheme (L9)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 490`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Packagist install regression + base URL without scheme (L9)**.
...
N/A — security review scheduled for FT492.
...
Automated FT490 (Packagist install regression + base URL without scheme (L9)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT491
