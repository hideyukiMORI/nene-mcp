# Field Trial 409 — Security review — catalog probes + Bearer bypass / empty token (L6)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 409`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Security review — catalog probes + Bearer bypass / empty token (L6)**.
...
N/A — security review scheduled for FT411.
...
Automated FT409 (Security review — catalog probes + Bearer bypass / empty token (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT410
