# Field Trial 18 — Phase B milestone reflection
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 18`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Phase B milestone reflection**.
...
Automated FT18 (Phase B milestone reflection): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT19
