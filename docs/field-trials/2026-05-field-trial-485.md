# Field Trial 485 — Catalog edge cases + null tools/call arguments (L9)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 485`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Catalog edge cases + null tools/call arguments (L9)**.
...
Automated FT485 (Catalog edge cases + null tools/call arguments (L9)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT486
