# Field Trial 399 — Security review — catalog probes + Query/base URL confusion (L6)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 399`
...
Automated FT399 (Security review — catalog probes + Query/base URL confusion (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT400
