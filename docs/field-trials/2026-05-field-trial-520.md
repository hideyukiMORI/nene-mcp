# Field Trial 520 — Packagist install regression + TLS CA on http base (L10)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 520`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Packagist install regression + TLS CA on http base (L10)**.
...
N/A — security review scheduled for FT522.
...
Automated FT520 (Packagist install regression + TLS CA on http base (L10)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT521
