# Field Trial 407 — Fresh clone bootstrap + Query/base URL confusion (L6)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 407`
...
Automated FT407 (Fresh clone bootstrap + Query/base URL confusion (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT408
