# Field Trial 30 — Packagist install regression
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 30`
...
Automated FT30 (Packagist install regression): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT31
