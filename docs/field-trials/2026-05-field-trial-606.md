# Field Trial 606 — NeNe Docker golden path smoke + stderr HTTP log line (L13)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 606`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **NeNe Docker golden path smoke + stderr HTTP log line (L13)**.
...
Automated FT606 (NeNe Docker golden path smoke + stderr HTTP log line (L13)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT607
