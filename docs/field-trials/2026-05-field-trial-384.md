# Field Trial 384 — Write fail-closed regression + SSRF off-host escape (L6)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 384`
...
Automated FT384 (Write fail-closed regression + SSRF off-host escape (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT385
