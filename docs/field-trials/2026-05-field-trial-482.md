# Field Trial 482 — About-only minimal install + JSON-RPC params array (L9)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 482`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **About-only minimal install + JSON-RPC params array (L9)**.
...
{"jsonrpc":"2.0","id":1,"error":{"code":-32603,"message":"MCP tool catalog could not be read from \"/tmp/ft-l8-482/bad.json}\"."}}
...
N/A — security review scheduled for FT483.
...
Automated FT482 (About-only minimal install + JSON-RPC params array (L9)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT483
