# Field Trial 390 — Packagist install regression + Catalog safety mislabel (L6)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 390`
...
Automated FT390 (Packagist install regression + Catalog safety mislabel (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT391
