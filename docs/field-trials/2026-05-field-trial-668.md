# Field Trial 668 — Combined smoke milestone + Bearer + timeout composite (L15)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 668`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Combined smoke milestone + Bearer + timeout composite (L15)**.
...
{"jsonrpc":"2.0","id":1,"error":{"code":-32603,"message":"MCP tool catalog could not be read from \"/tmp/ft-l8-668/bad.json}\"."}}
...
Automated FT668 (Combined smoke milestone + Bearer + timeout composite (L15)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT669
