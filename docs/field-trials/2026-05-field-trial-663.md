# Field Trial 663 — Misconfiguration adversarial + NENE2 base + Bearer (L15)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 663`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Misconfiguration adversarial + NENE2 base + Bearer (L15)**.
...
Automated FT663 (Misconfiguration adversarial + NENE2 base + Bearer (L15)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT664
