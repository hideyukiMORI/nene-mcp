# Field Trial 516 — NeNe Docker golden path smoke + HTTP timeout env (L10)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 516`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **NeNe Docker golden path smoke + HTTP timeout env (L10)**.
...
Automated FT516 (NeNe Docker golden path smoke + HTTP timeout env (L10)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT517
