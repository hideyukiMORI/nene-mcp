# Field Trial 445 — Catalog edge cases + double JSON-RPC stdin (L7)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 445`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Catalog edge cases + double JSON-RPC stdin (L7)**.
...
N/A — security review scheduled for FT447.
...
Automated FT445 (Catalog edge cases + double JSON-RPC stdin (L7)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT446
