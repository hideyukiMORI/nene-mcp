# Field Trial 472 — About-only minimal install + empty base URL (L8)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 472`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **About-only minimal install + empty base URL (L8)**.
...
Automated FT472 (About-only minimal install + empty base URL (L8)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT473
