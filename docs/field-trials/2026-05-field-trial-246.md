# Field Trial 246 — NeNe Docker golden path smoke + NeNe multi-read (L3)
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 246`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **NeNe Docker golden path smoke + NeNe multi-read (L3)**.
...
Automated FT246 (NeNe Docker golden path smoke + NeNe multi-read (L3)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT247
