# Field Trial 715 — Catalog edge cases + empty title rejected (L16)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 715`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Catalog edge cases + empty title rejected (L16)**.
...
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"getTodoById\",\n    \"operationId\": \"getTodo\",\n    \"statusCode\": 401,\n    \"requestId\": \"ce583b374e717c07edef4fce1fecb4d2\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"failure\",\n            \"errorCode\": \"SESSION-CLOSED\",\n            \"errorMessage\": \"Session timeout. Please log in again.\"\n        }\n    }\n}"}],"structuredContent":{"tool":"getTodoById","operationId":"getTodo","statusCode":401,"requestId":"ce583b374e717c07edef4fce1fecb4d2","body":{"Result":true,"Data":{"status":"failure","errorCode":"SESSION-CLOSED","errorMessage":"Session timeout. Please log in again."}}},"isError":true}}
...
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"createTodo\",\n    \"operationId\": \"createTodo\",\n    \"statusCode\": 200,\n    \"requestId\": \"3979357e5ff8787f1bc30b3cc4f7e48b\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"success\",\n            \"errorCode\": \"\",\n            \"todo\": {\n                \"id\": 110,\n                \"user_id\": 1,\n                \"title\": \"FT630 L14 write\",\n                \"is_completed\": false,\n                \"created_at\": \"2026-05-22 16:03:21\",\n                \"updated_at\": \"2026-05-22 16:03:21\"\n            }\n        }\n    }\n}"}],"structuredContent":{"tool":"createTodo","operationId":"createTodo","statusCode":200,"requestId":"3979357e5ff8787f1bc30b3cc4f7e48b","body":{"Result":true,"Data":{"status":"success","errorCode":"","todo":{"id":110,"user_id":1,"title":"FT630 L14 write","is_completed":false,"created_at":"2026-05-22 16:03:21","updated_at":"2026-05-22 16:03:21"}}}},"isError":false}}
ADV-PASS Bearer createTodo without CSRF

# L15 probe (FT660+, Bearer+operator composite, variant 1)
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"createTodo\",\n    \"operationId\": \"createTodo\",\n    \"statusCode\": 200,\n    \"requestId\": \"76edaa10bdb8cca77e5d436ed78ad5c7\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"success\",\n            \"errorCode\": \"\",\n            \"todo\": {\n                \"id\": 111,\n                \"user_id\": 1,\n                \"title\": \"L15 roundtrip\",\n                \"is_completed\": false,\n                \"created_at\": \"2026-05-22 16:03:21\",\n                \"updated_at\": \"2026-05-22 16:03:21\"\n            }\n        }\n    }\n}"}],"structuredContent":{"tool":"createTodo","operationId":"createTodo","statusCode":200,"requestId":"76edaa10bdb8cca77e5d436ed78ad5c7","body":{"Result":true,"Data":{"status":"success","errorCode":"","todo":{"id":111,"user_id":1,"title":"L15 roundtrip","is_completed":false,"created_at":"2026-05-22 16:03:21","updated_at":"2026-05-22 16:03:21"}}}},"isError":false}}
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"getTodoById\",\n    \"operationId\": \"getTodo\",\n    \"statusCode\": 200,\n    \"requestId\": \"483f18f48b2654d69845c702657be309\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"success\",\n            \"errorCode\": \"\",\n            \"todo\": {\n                \"id\": 111,\n                \"user_id\": 1,\n                \"title\": \"L15 roundtrip\",\n                \"is_completed\": false,\n                \"created_at\": \"2026-05-22 16:03:21\",\n                \"updated_at\": \"2026-05-22 16:03:21\"\n            }\n        }\n    }\n}"}],"structuredContent":{"tool":"getTodoById","operationId":"getTodo","statusCode":200,"requestId":"483f18f48b2654d69845c702657be309","body":{"Result":true,"Data":{"status":"success","errorCode":"","todo":{"id":111,"user_id":1,"title":"L15 roundtrip","is_completed":false,"created_at":"2026-05-22 16:03:21","updated_at":"2026-05-22 16:03:21"}}}},"isError":false}}
ADV-PASS create/read round-trip id_111

# L16 probe (FT690+, NeNe observability, variant 1)
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"createTodo\",\n    \"operationId\": \"createTodo\",\n    \"statusCode\": 400,\n    \"requestId\": \"e5c5677fb4ad851ba2d9faba359a9ba6\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"failure\",\n            \"errorCode\": \"TODO-TITLE-REQUIRED\",\n            \"errorMessage\": \"TODO title is required.\"\n        }\n    }\n}"}],"structuredContent":{"tool":"createTodo","operationId":"createTodo","statusCode":400,"requestId":"e5c5677fb4ad851ba2d9faba359a9ba6","body":{"Result":true,"Data":{"status":"failure","errorCode":"TODO-TITLE-REQUIRED","errorMessage":"TODO title is required."}}},"isError":true}}
...
N/A — security review scheduled for FT717.
...
Automated FT715 (Catalog edge cases + empty title rejected (L16)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT716
