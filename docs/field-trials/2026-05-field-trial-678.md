# Field Trial 678 — Combined smoke milestone + unicode Bearer write (L15)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 678`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Combined smoke milestone + unicode Bearer write (L15)**.
...
Automated FT678 (Combined smoke milestone + unicode Bearer write (L15)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT679
