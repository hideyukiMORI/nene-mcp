# Field Trial 458 — Combined smoke milestone + truncated catalog JSON (L8)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 458`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Combined smoke milestone + truncated catalog JSON (L8)**.
...
{"jsonrpc":"2.0","id":1,"error":{"code":-32603,"message":"MCP tool catalog could not be read from \"/tmp/ft-l8-458/bad.json}\"."}}
...
N/A — security review scheduled for FT459.
...
Automated FT458 (Combined smoke milestone + truncated catalog JSON (L8)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT459
