# Field Trial 587 — Fresh clone bootstrap + bearer trim + operator (L12)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 587`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Fresh clone bootstrap + bearer trim + operator (L12)**.
...
Automated FT587 (Fresh clone bootstrap + bearer trim + operator (L12)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT588
