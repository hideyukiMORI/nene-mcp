# Field Trial 263 — Misconfiguration adversarial + Query/base URL confusion (L6)
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 263`
...
N/A — security review scheduled for FT264.
...
Automated FT263 (Misconfiguration adversarial + Query/base URL confusion (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT264
