# Field Trial 172 — About-only minimal install
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 172`
...
N/A — security review scheduled for FT174.
...
Automated FT172 (About-only minimal install): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT173
