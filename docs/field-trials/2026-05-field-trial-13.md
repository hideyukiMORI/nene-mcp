# Field Trial 13 — Cross-platform host bootstrap
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 13`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Cross-platform host bootstrap**.
...
N/A — security review scheduled for FT15.
...
Automated FT13 (Cross-platform host bootstrap): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT14
