# Field Trial 122 — About-only minimal install
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 122`
...
N/A — security review scheduled for FT123.
...
Automated FT122 (About-only minimal install): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT123
