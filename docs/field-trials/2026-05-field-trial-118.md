# Field Trial 118 — Combined smoke milestone
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 118`
...
Automated FT118 (Combined smoke milestone): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT119
