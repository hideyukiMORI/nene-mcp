# Field Trial 178 — Combined smoke milestone
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 178`
...
Automated FT178 (Combined smoke milestone): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT179
