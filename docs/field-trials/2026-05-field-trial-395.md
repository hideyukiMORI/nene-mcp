# Field Trial 395 — Catalog edge cases + Path param injection (L6)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 395`
...
Automated FT395 (Catalog edge cases + Path param injection (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT396
