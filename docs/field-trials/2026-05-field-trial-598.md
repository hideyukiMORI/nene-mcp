# Field Trial 598 — Combined smoke milestone + HTTPS TLS CA flag (L12)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 598`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Combined smoke milestone + HTTPS TLS CA flag (L12)**.
...
Automated FT598 (Combined smoke milestone + HTTPS TLS CA flag (L12)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT599
