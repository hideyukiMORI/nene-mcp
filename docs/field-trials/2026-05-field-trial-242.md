# Field Trial 242 — About-only minimal install + NeNe TODO session wall (L5)
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 242`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **About-only minimal install + NeNe TODO session wall (L5)**.
...
Automated FT242 (About-only minimal install + NeNe TODO session wall (L5)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT243
