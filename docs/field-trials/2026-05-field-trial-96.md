# Field Trial 96 — NeNe Docker golden path smoke
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 96`
...
Automated FT96 (NeNe Docker golden path smoke): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT97
