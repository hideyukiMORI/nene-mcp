# Field Trial 377 — Fresh clone bootstrap + Bearer bypass / empty token (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 377`
...
Automated FT377 (Fresh clone bootstrap + Bearer bypass / empty token (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT378
