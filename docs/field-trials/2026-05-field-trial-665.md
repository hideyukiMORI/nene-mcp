# Field Trial 665 — Catalog edge cases + sessionLogin fail-closed (L15)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 665`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Catalog edge cases + sessionLogin fail-closed (L15)**.
...
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"listTodos\",\n    \"operationId\": \"listTodos\",\n    \"statusCode\": 401,\n    \"requestId\": \"8f306f4be43c9598ab9986ab6cacedb6\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"failure\",\n            \"errorCode\": \"SESSION-CLOSED\",\n            \"errorMessage\": \"Session timeout. Please log in again.\"\n        }\n    }\n}"}],"structuredContent":{"tool":"listTodos","operationId":"listTodos","statusCode":401,"requestId":"8f306f4be43c9598ab9986ab6cacedb6","body":{"Result":true,"Data":{"status":"failure","errorCode":"SESSION-CLOSED","errorMessage":"Session timeout. Please log in again."}}},"isError":true}}
...
N/A — security review scheduled for FT666.
...
Automated FT665 (Catalog edge cases + sessionLogin fail-closed (L15)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT666
