# Field Trial 301 — Multi-tool read catalog + NeNe CSRF write re-attack (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 301`
...
Automated FT301 (Multi-tool read catalog + NeNe CSRF write re-attack (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT302
