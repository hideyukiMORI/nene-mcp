# Field Trial 431 — Multi-tool read catalog + empty-string Bearer (L7)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 431`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Multi-tool read catalog + empty-string Bearer (L7)**.
...
Automated FT431 (Multi-tool read catalog + empty-string Bearer (L7)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT432
