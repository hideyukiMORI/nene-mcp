# Field Trial 550 — Packagist install regression + empty TLS CA path (L11)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 550`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Packagist install regression + empty TLS CA path (L11)**.
...
Automated FT550 (Packagist install regression + empty TLS CA path (L11)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT551
