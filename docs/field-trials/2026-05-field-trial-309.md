# Field Trial 309 — Security review — catalog probes + NeNe CSRF write re-attack (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 309`
...
Automated FT309 (Security review — catalog probes + NeNe CSRF write re-attack (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT310
