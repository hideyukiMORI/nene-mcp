# Field Trial 256 — NeNe Docker golden path smoke + SSRF off-host escape (L6)
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 256`
...
Automated FT256 (NeNe Docker golden path smoke + SSRF off-host escape (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT257
