# Field Trial 575 — Catalog edge cases + bearer trim + operator (L12)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 575`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Catalog edge cases + bearer trim + operator (L12)**.
...
Automated FT575 (Catalog edge cases + bearer trim + operator (L12)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT576
