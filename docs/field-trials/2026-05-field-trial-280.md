# Field Trial 280 — Packagist install regression + SSRF off-host escape (L6)
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 280`
...
Automated FT280 (Packagist install regression + SSRF off-host escape (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT281
