# Field Trial 442 — About-only minimal install + unicode path param (L7)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 442`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **About-only minimal install + unicode path param (L7)**.
...
Automated FT442 (About-only minimal install + unicode path param (L7)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT443
