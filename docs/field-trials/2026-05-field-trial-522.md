# Field Trial 522 — About-only minimal install + HTTP timeout env (L10)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 522`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **About-only minimal install + HTTP timeout env (L10)**.
...
Automated FT522 (About-only minimal install + HTTP timeout env (L10)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT523
