# Field Trial 612 — About-only minimal install + stderr HTTP log line (L13)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 612`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **About-only minimal install + stderr HTTP log line (L13)**.
...
Automated FT612 (About-only minimal install + stderr HTTP log line (L13)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT613
