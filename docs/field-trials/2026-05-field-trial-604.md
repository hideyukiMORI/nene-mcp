# Field Trial 604 — Write fail-closed regression + write fail-closed + timeout (L13)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 604`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Write fail-closed regression + write fail-closed + timeout (L13)**.
...
N/A — security review scheduled for FT606.
...
Automated FT604 (Write fail-closed regression + write fail-closed + timeout (L13)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT605
