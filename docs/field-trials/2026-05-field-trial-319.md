# Field Trial 319 — Security review — catalog probes + Query/base URL confusion (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 319`
...
N/A — security review scheduled for FT321.
...
Automated FT319 (Security review — catalog probes + Query/base URL confusion (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT320
