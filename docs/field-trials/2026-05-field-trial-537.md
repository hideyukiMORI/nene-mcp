# Field Trial 537 — Fresh clone bootstrap + stderr log flag (L10)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 537`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Fresh clone bootstrap + stderr log flag (L10)**.
...
Automated FT537 (Fresh clone bootstrap + stderr log flag (L10)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT538
