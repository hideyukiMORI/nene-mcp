# Field Trial 386 — NeNe Docker golden path smoke + JSON-RPC fuzz (L6)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 386`
...
Automated FT386 (NeNe Docker golden path smoke + JSON-RPC fuzz (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT387
