# Field Trial 168 — Combined smoke milestone
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 168`
...
Automated FT168 (Combined smoke milestone): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT169
