# Field Trial 304 — Write fail-closed regression + SSRF off-host escape (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 304`
...
N/A — security review scheduled for FT306.
...
Automated FT304 (Write fail-closed regression + SSRF off-host escape (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT305
