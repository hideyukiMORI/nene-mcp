# Field Trial 190 — Packagist install regression
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 190`
...
Automated FT190 (Packagist install regression): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT191
