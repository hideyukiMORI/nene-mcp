# Field Trial 15 — Security review — cross-runtime
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 15`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Security review — cross-runtime**.
...
Automated FT15 (Security review — cross-runtime): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT16
