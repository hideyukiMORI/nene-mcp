# Field Trial 564 — Write fail-closed regression + timeout min boundary (L11)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 564`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Write fail-closed regression + timeout min boundary (L11)**.
...
Automated FT564 (Write fail-closed regression + timeout min boundary (L11)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT565
