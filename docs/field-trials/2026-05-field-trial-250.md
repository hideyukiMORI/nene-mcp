# Field Trial 250 — Packagist install regression + Bearer-native E2E (L4)
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 250`
...
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"createInventoryItem\",\n    \"operationId\": \"createItem\",\n    \"statusCode\": 201,\n    \"requestId\": null,\n    \"body\": {\n        \"id\": 2,\n        \"sku\": \"FT250\",\n        \"qty\": 1\n    }\n}"}],"structuredContent":{"tool":"createInventoryItem","operationId":"createItem","statusCode":201,"requestId":null,"body":{"id":2,"sku":"FT250","qty":1}},"isError":false}}
...
N/A — security review scheduled for FT252.
...
Automated FT250 (Packagist install regression + Bearer-native E2E (L4)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT251
