# Field Trial 274 — Write fail-closed regression + JSON-RPC fuzz (L6)
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 274`
...
Automated FT274 (Write fail-closed regression + JSON-RPC fuzz (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT275
