# Field Trial 599 — Security review — catalog probes + bearer trim + operator (L12)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 599`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Security review — catalog probes + bearer trim + operator (L12)**.
...
N/A — security review scheduled for FT600.
...
Automated FT599 (Security review — catalog probes + bearer trim + operator (L12)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT600
