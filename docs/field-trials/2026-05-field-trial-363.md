# Field Trial 363 — Misconfiguration adversarial + Path param injection (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 363`
...
Automated FT363 (Misconfiguration adversarial + Path param injection (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT364
