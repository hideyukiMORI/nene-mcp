# Field Trial 287 — Fresh clone bootstrap + Query/base URL confusion (L6)
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 287`
...
Automated FT287 (Fresh clone bootstrap + Query/base URL confusion (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT288
