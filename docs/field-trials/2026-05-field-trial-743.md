# Field Trial 743 — Misconfiguration adversarial + requestId on Bearer write (L17)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 743`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Misconfiguration adversarial + requestId on Bearer write (L17)**.
...
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"listTodos\",\n    \"operationId\": \"listTodos\",\n    \"statusCode\": 401,\n    \"requestId\": \"cc2c6bb0b4d47b9688c5a1a62120422f\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"failure\",\n            \"errorCode\": \"SESSION-CLOSED\",\n            \"errorMessage\": \"Session timeout. Please log in again.\"\n        }\n    }\n}"}],"structuredContent":{"tool":"listTodos","operationId":"listTodos","statusCode":401,"requestId":"cc2c6bb0b4d47b9688c5a1a62120422f","body":{"Result":true,"Data":{"status":"failure","errorCode":"SESSION-CLOSED","errorMessage":"Session timeout. Please log in again."}}},"isError":true}}
...
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"createTodo\",\n    \"operationId\": \"createTodo\",\n    \"statusCode\": 200,\n    \"requestId\": \"125e2b84fc100967fb61297f2be88b74\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"success\",\n            \"errorCode\": \"\",\n            \"todo\": {\n                \"id\": 141,\n                \"user_id\": 1,\n                \"title\": \"L16xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\",\n                \"is_completed\": false,\n                \"created_at\": \"2026-05-22 16:13:04\",\n                \"updated_at\": \"2026-05-22 16:13:04\"\n            }\n        }\n    }\n}"}],"structuredContent":{"tool":"createTodo","operationId":"createTodo","statusCode":200,"requestId":"125e2b84fc100967fb61297f2be88b74","body":{"Result":true,"Data":{"status":"success","errorCode":"","todo":{"id":141,"user_id":1,"title":"L16xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx","is_completed":false,"created_at":"2026-05-22 16:13:04","updated_at":"2026-05-22 16:13:04"}}}},"isError":false}}
ADV-PASS long title (200 chars) accepted

# L17 probe (FT720+, Bearer gate sustain, variant 5)
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"createTodo\",\n    \"operationId\": \"createTodo\",\n    \"statusCode\": 200,\n    \"requestId\": \"103f30b061e970c4eac1428160c32b9f\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"success\",\n            \"errorCode\": \"\",\n            \"todo\": {\n                \"id\": 142,\n                \"user_id\": 1,\n                \"title\": \"L17 requestId write\",\n                \"is_completed\": false,\n                \"created_at\": \"2026-05-22 16:13:04\",\n                \"updated_at\": \"2026-05-22 16:13:04\"\n            }\n        }\n    }\n}"}],"structuredContent":{"tool":"createTodo","operationId":"createTodo","statusCode":200,"requestId":"103f30b061e970c4eac1428160c32b9f","body":{"Result":true,"Data":{"status":"success","errorCode":"","todo":{"id":142,"user_id":1,"title":"L17 requestId write","is_completed":false,"created_at":"2026-05-22 16:13:04","updated_at":"2026-05-22 16:13:04"}}}},"isError":false}}
...
N/A — security review scheduled for FT744.
...
Automated FT743 (Misconfiguration adversarial + requestId on Bearer write (L17)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT744
