# Field Trial 570 — Packagist install regression + NENE2 base URL alias (L12)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 570`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Packagist install regression + NENE2 base URL alias (L12)**.
...
Automated FT570 (Packagist install regression + NENE2 base URL alias (L12)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT571
