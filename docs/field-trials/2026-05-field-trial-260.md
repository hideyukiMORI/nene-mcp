# Field Trial 260 — Packagist install regression + Secret leak probe (L6)
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 260`
...
Automated FT260 (Packagist install regression + Secret leak probe (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT261
