# Field Trial 561 — Multi-tool read catalog + invalid log value (L11)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 561`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Multi-tool read catalog + invalid log value (L11)**.
...
Automated FT561 (Multi-tool read catalog + invalid log value (L11)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT562
