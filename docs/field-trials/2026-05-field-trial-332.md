# Field Trial 332 — About-only minimal install + Secret leak probe (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 332`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **About-only minimal install + Secret leak probe (L6)**.
...
N/A — security review scheduled for FT333.
...
Automated FT332 (About-only minimal install + Secret leak probe (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT333
