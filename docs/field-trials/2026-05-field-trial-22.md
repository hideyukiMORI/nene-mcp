# Field Trial 22 — About-only minimal install
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 22`
...
N/A — security review scheduled for FT24.
...
Automated FT22 (About-only minimal install): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT23
