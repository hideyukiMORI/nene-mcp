# Field Trial 385 — Catalog edge cases + Bearer bypass / empty token (L6)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 385`
...
N/A — security review scheduled for FT387.
...
Automated FT385 (Catalog edge cases + Bearer bypass / empty token (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT386
