# Field Trial 468 — Combined smoke milestone + newline/tab Bearer (L8)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 468`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Combined smoke milestone + newline/tab Bearer (L8)**.
...
Automated FT468 (Combined smoke milestone + newline/tab Bearer (L8)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT469
