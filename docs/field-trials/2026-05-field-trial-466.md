# Field Trial 466 — NeNe Docker golden path smoke + empty base URL (L8)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 466`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **NeNe Docker golden path smoke + empty base URL (L8)**.
...
Automated FT466 (NeNe Docker golden path smoke + empty base URL (L8)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT467
