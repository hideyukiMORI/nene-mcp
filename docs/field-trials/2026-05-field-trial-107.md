# Field Trial 107 — Fresh clone bootstrap
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 107`
...
Automated FT107 (Fresh clone bootstrap): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT108
