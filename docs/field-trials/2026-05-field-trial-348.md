# Field Trial 348 — Combined smoke milestone + Secret leak probe (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 348`
...
Automated FT348 (Combined smoke milestone + Secret leak probe (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT349
