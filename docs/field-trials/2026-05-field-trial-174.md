# Field Trial 174 — Write fail-closed regression
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 174`
...
Automated FT174 (Write fail-closed regression): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT175
