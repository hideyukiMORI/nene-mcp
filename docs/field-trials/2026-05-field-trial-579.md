# Field Trial 579 — Security review — catalog probes + leading-zero timeout (L12)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 579`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Security review — catalog probes + leading-zero timeout (L12)**.
...
Automated FT579 (Security review — catalog probes + leading-zero timeout (L12)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT580
