# Field Trial 619 — Security review — catalog probes + float timeout fallback (L13)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 619`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Security review — catalog probes + float timeout fallback (L13)**.
...
Automated FT619 (Security review — catalog probes + float timeout fallback (L13)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT620
