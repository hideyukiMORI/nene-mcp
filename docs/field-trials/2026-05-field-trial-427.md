# Field Trial 427 — Fresh clone bootstrap + double JSON-RPC stdin (L7)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 427`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Fresh clone bootstrap + double JSON-RPC stdin (L7)**.
...
Automated FT427 (Fresh clone bootstrap + double JSON-RPC stdin (L7)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT428
