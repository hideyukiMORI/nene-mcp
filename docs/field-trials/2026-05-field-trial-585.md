# Field Trial 585 — Catalog edge cases + leading-zero timeout (L12)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 585`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Catalog edge cases + leading-zero timeout (L12)**.
...
Automated FT585 (Catalog edge cases + leading-zero timeout (L12)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT586
