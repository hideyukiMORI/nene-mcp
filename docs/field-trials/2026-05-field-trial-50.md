# Field Trial 50 — Packagist install regression
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 50`
...
Automated FT50 (Packagist install regression): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT51
