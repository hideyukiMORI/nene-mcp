# Field Trial 521 — Multi-tool read catalog + v0.1.8 baseline pin (L10)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 521`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Multi-tool read catalog + v0.1.8 baseline pin (L10)**.
...
Automated FT521 (Multi-tool read catalog + v0.1.8 baseline pin (L10)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT522
