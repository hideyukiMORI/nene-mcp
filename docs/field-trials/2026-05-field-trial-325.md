# Field Trial 325 — Catalog edge cases + NeNe CSRF write re-attack (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 325`
...
Automated FT325 (Catalog edge cases + NeNe CSRF write re-attack (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT326
