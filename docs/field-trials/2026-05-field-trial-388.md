# Field Trial 388 — Combined smoke milestone + Secret leak probe (L6)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 388`
...
Automated FT388 (Combined smoke milestone + Secret leak probe (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT389
