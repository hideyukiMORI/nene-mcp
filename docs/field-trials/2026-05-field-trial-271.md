# Field Trial 271 — Multi-tool read catalog + Query/base URL confusion (L6)
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 271`
...
Automated FT271 (Multi-tool read catalog + Query/base URL confusion (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT272
