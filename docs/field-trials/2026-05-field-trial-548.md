# Field Trial 548 — Combined smoke milestone + timeout out-of-range clamp (L11)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 548`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Combined smoke milestone + timeout out-of-range clamp (L11)**.
...
{"jsonrpc":"2.0","id":1,"error":{"code":-32603,"message":"MCP tool catalog could not be read from \"/tmp/ft-l8-548/bad.json}\"."}}
...
N/A — security review scheduled for FT549.
...
Automated FT548 (Combined smoke milestone + timeout out-of-range clamp (L11)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT549
