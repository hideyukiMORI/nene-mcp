# Field Trial 369 — Security review — catalog probes + Bearer bypass / empty token (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 369`
...
Automated FT369 (Security review — catalog probes + Bearer bypass / empty token (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT370
