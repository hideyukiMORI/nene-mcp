# Field Trial 239 — Security review — catalog probes + Packagist 0.1.4 pin
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 239`
...
Automated FT239 (Security review — catalog probes + Packagist 0.1.4 pin): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT240
