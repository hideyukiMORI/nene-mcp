# Field Trial 449 — Security review — catalog probes + empty-string Bearer (L7)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 449`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Security review — catalog probes + empty-string Bearer (L7)**.
...
N/A — security review scheduled for FT450.
...
Automated FT449 (Security review — catalog probes + empty-string Bearer (L7)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT450
