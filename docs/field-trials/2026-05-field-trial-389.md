# Field Trial 389 — Security review — catalog probes + NeNe CSRF write re-attack (L6)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 389`
...
N/A — security review scheduled for FT390.
...
Automated FT389 (Security review — catalog probes + NeNe CSRF write re-attack (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT390
