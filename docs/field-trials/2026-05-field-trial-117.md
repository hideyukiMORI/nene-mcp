# Field Trial 117 — Fresh clone bootstrap
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 117`
...
Automated FT117 (Fresh clone bootstrap): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT118
