# Field Trial 108 — Combined smoke milestone
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 108`
...
Automated FT108 (Combined smoke milestone): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT109
