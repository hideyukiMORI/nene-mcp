# Field Trial 425 — Catalog edge cases + empty-string Bearer (L7)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 425`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Catalog edge cases + empty-string Bearer (L7)**.
...
N/A — security review scheduled for FT426.
...
Automated FT425 (Catalog edge cases + empty-string Bearer (L7)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT426
