# Field Trial 90 — Packagist install regression
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 90`
...
Automated FT90 (Packagist install regression): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT91
