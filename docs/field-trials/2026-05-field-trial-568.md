# Field Trial 568 — Combined smoke milestone + empty TLS CA path (L11)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 568`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Combined smoke milestone + empty TLS CA path (L11)**.
...
Automated FT568 (Combined smoke milestone + empty TLS CA path (L11)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT569
