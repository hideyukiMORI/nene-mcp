# Field Trial 477 — Fresh clone bootstrap + duplicate tool names (L8)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 477`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Fresh clone bootstrap + duplicate tool names (L8)**.
...
Automated FT477 (Fresh clone bootstrap + duplicate tool names (L8)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT478
