# Field Trial 396 — NeNe Docker golden path smoke + Secret leak probe (L6)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 396`
...
Automated FT396 (NeNe Docker golden path smoke + Secret leak probe (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT397
