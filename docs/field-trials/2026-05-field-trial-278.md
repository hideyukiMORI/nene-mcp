# Field Trial 278 — Combined smoke milestone + Catalog safety mislabel (L6)
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 278`
...
Automated FT278 (Combined smoke milestone + Catalog safety mislabel (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT279
