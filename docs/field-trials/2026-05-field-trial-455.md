# Field Trial 455 — Catalog edge cases + invalid JSON-RPC version (L8)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 455`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Catalog edge cases + invalid JSON-RPC version (L8)**.
...
N/A — security review scheduled for FT456.
...
Automated FT455 (Catalog edge cases + invalid JSON-RPC version (L8)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT456
