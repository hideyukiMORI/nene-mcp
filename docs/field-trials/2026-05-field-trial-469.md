# Field Trial 469 — Security review — catalog probes + trailing-space base URL (L8)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 469`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Security review — catalog probes + trailing-space base URL (L8)**.
...
N/A — security review scheduled for FT471.
...
Automated FT469 (Security review — catalog probes + trailing-space base URL (L8)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT470
