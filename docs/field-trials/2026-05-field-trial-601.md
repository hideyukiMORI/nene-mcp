# Field Trial 601 — Multi-tool read catalog + float timeout fallback (L13)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 601`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Multi-tool read catalog + float timeout fallback (L13)**.
...
Automated FT601 (Multi-tool read catalog + float timeout fallback (L13)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT602
