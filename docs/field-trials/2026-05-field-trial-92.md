# Field Trial 92 — About-only minimal install
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 92`
...
N/A — security review scheduled for FT93.
...
Automated FT92 (About-only minimal install): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT93
