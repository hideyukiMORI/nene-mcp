# Field Trial 478 — Combined smoke milestone + empty base URL (L8)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 478`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Combined smoke milestone + empty base URL (L8)**.
...
N/A — security review scheduled for FT480.
...
Automated FT478 (Combined smoke milestone + empty base URL (L8)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT479
