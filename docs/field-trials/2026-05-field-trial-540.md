# Field Trial 540 — Packagist install regression + timeout min boundary (L11)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 540`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Packagist install regression + timeout min boundary (L11)**.
...
Automated FT540 (Packagist install regression + timeout min boundary (L11)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT541
