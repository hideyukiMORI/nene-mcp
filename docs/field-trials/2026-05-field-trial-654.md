# Field Trial 654 — Write fail-closed regression + Bearer listTodos regression (L14)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 654`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Write fail-closed regression + Bearer listTodos regression (L14)**.
...
Automated FT654 (Write fail-closed regression + Bearer listTodos regression (L14)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT655
