# Field Trial 586 — NeNe Docker golden path smoke + HTTPS TLS CA flag (L12)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 586`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **NeNe Docker golden path smoke + HTTPS TLS CA flag (L12)**.
...
N/A — security review scheduled for FT588.
...
Automated FT586 (NeNe Docker golden path smoke + HTTPS TLS CA flag (L12)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT587
