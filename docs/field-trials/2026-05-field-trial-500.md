# Field Trial 500 — Packagist install regression + JSON-RPC params array (L9)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 500`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Packagist install regression + JSON-RPC params array (L9)**.
...
{"jsonrpc":"2.0","id":1,"error":{"code":-32603,"message":"MCP tool catalog could not be read from \"/tmp/ft-l8-500/bad.json}\"."}}
...
N/A — security review scheduled for FT501.
...
Automated FT500 (Packagist install regression + JSON-RPC params array (L9)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT501
