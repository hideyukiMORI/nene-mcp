# Field Trial 508 — Combined smoke milestone + base URL without scheme (L9)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 508`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Combined smoke milestone + base URL without scheme (L9)**.
...
Automated FT508 (Combined smoke milestone + base URL without scheme (L9)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT509
