# Field Trial 317 — Fresh clone bootstrap + NeNe CSRF write re-attack (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 317`
...
Automated FT317 (Fresh clone bootstrap + NeNe CSRF write re-attack (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT318
