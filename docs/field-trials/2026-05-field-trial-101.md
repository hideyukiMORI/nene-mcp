# Field Trial 101 — Multi-tool read catalog
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 101`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Multi-tool read catalog**.
...
N/A — security review scheduled for FT102.
...
Automated FT101 (Multi-tool read catalog): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT102
