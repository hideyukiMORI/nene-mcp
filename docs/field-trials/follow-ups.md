...
| FT201–224 | FT204 | NeNe TODO session cookie + CSRF — stock E2E blocked over MCP | fix-in-host | [NeNe #380](https://github.com/hideyukiMORI/NeNe/issues/380); re-verified FT225–254 persona probe variant 2 |
