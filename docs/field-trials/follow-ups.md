...
| FT201–294 | FT204 | NeNe TODO session cookie + CSRF — stock E2E blocked over MCP | **resolved** | [NeNe #395](https://github.com/hideyukiMORI/NeNe/issues/395) closed — **FT450 PASS** ([gate](nene-380-confirmation-gate.md), [report](2026-05-field-trial-450.md)) |
