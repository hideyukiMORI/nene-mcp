...
| FT201–294 | FT204 | NeNe TODO session cookie + CSRF — stock E2E blocked over MCP | fix-in-host | [NeNe #380](https://github.com/hideyukiMORI/NeNe/issues/380), [#395](https://github.com/hideyukiMORI/NeNe/issues/395) — **await NeNe merge**; confirm via [FT450 gate](nene-380-confirmation-gate.md) |
