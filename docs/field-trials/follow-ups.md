...
| FT201–294 | FT204 | NeNe TODO session cookie + CSRF — stock E2E blocked over MCP | fix-in-host | [NeNe #395](https://github.com/hideyukiMORI/NeNe/issues/395) — **assigned; await host merge**; confirm via [FT450 gate](nene-380-confirmation-gate.md) |
