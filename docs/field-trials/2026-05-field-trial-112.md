# Field Trial 112 — About-only minimal install
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 112`
...
N/A — security review scheduled for FT114.
...
Automated FT112 (About-only minimal install): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT113
