# Field Trial 507 — Fresh clone bootstrap + DELETE write safety (L9)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 507`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Fresh clone bootstrap + DELETE write safety (L9)**.
...
Automated FT507 (Fresh clone bootstrap + DELETE write safety (L9)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT508
