# Field Trial 259 — Security review — catalog probes + Path param injection (L6)
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 259`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Security review — catalog probes + Path param injection (L6)**.
...
N/A — security review scheduled for FT261.
...
Automated FT259 (Security review — catalog probes + Path param injection (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT260
