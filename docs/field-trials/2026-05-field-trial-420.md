# Field Trial 420 — Packagist install regression + wrong Bearer env typo (L7)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 420`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Packagist install regression + wrong Bearer env typo (L7)**.
...
Automated FT420 (Packagist install regression + wrong Bearer env typo (L7)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT421
