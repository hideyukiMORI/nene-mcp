# Field Trial 769 — Security review — catalog probes + createTodo invalid Bearer (L18)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 769`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Security review — catalog probes + createTodo invalid Bearer (L18)**.
...
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"createTodo\",\n    \"operationId\": \"createTodo\",\n    \"statusCode\": 200,\n    \"requestId\": \"59a00a7483e0ad349eb4210bc6aef97f\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"success\",\n            \"errorCode\": \"\",\n            \"todo\": {\n                \"id\": 172,\n                \"user_id\": 1,\n                \"title\": \"FT630 L14 write\",\n                \"is_completed\": false,\n                \"created_at\": \"2026-05-22 16:16:11\",\n                \"updated_at\": \"2026-05-22 16:16:11\"\n            }\n        }\n    }\n}"}],"structuredContent":{"tool":"createTodo","operationId":"createTodo","statusCode":200,"requestId":"59a00a7483e0ad349eb4210bc6aef97f","body":{"Result":true,"Data":{"status":"success","errorCode":"","todo":{"id":172,"user_id":1,"title":"FT630 L14 write","is_completed":false,"created_at":"2026-05-22 16:16:11","updated_at":"2026-05-22 16:16:11"}}}},"isError":false}}
ADV-PASS Bearer createTodo without CSRF

# L15 probe (FT660+, Bearer+operator composite, variant 1)
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"createTodo\",\n    \"operationId\": \"createTodo\",\n    \"statusCode\": 200,\n    \"requestId\": \"35ef6e3adb020a8e641787256d5bb995\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"success\",\n            \"errorCode\": \"\",\n            \"todo\": {\n                \"id\": 173,\n                \"user_id\": 1,\n                \"title\": \"L15 roundtrip\",\n                \"is_completed\": false,\n                \"created_at\": \"2026-05-22 16:16:11\",\n                \"updated_at\": \"2026-05-22 16:16:11\"\n            }\n        }\n    }\n}"}],"structuredContent":{"tool":"createTodo","operationId":"createTodo","statusCode":200,"requestId":"35ef6e3adb020a8e641787256d5bb995","body":{"Result":true,"Data":{"status":"success","errorCode":"","todo":{"id":173,"user_id":1,"title":"L15 roundtrip","is_completed":false,"created_at":"2026-05-22 16:16:11","updated_at":"2026-05-22 16:16:11"}}}},"isError":false}}
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"getTodoById\",\n    \"operationId\": \"getTodo\",\n    \"statusCode\": 200,\n    \"requestId\": \"36fe5cc7fe77fe1ced059b8845cfcfea\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"success\",\n            \"errorCode\": \"\",\n            \"todo\": {\n                \"id\": 173,\n                \"user_id\": 1,\n                \"title\": \"L15 roundtrip\",\n                \"is_completed\": false,\n                \"created_at\": \"2026-05-22 16:16:11\",\n                \"updated_at\": \"2026-05-22 16:16:11\"\n            }\n        }\n    }\n}"}],"structuredContent":{"tool":"getTodoById","operationId":"getTodo","statusCode":200,"requestId":"36fe5cc7fe77fe1ced059b8845cfcfea","body":{"Result":true,"Data":{"status":"success","errorCode":"","todo":{"id":173,"user_id":1,"title":"L15 roundtrip","is_completed":false,"created_at":"2026-05-22 16:16:11","updated_at":"2026-05-22 16:16:11"}}}},"isError":false}}
ADV-PASS create/read round-trip id_173

# L16 probe (FT690+, NeNe observability, variant 1)
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"createTodo\",\n    \"operationId\": \"createTodo\",\n    \"statusCode\": 400,\n    \"requestId\": \"f4b212ebcb0e2d9c23ffb44d84de0514\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"failure\",\n            \"errorCode\": \"TODO-TITLE-REQUIRED\",\n            \"errorMessage\": \"TODO title is required.\"\n        }\n    }\n}"}],"structuredContent":{"tool":"createTodo","operationId":"createTodo","statusCode":400,"requestId":"f4b212ebcb0e2d9c23ffb44d84de0514","body":{"Result":true,"Data":{"status":"failure","errorCode":"TODO-TITLE-REQUIRED","errorMessage":"TODO title is required."}}},"isError":true}}
ADV-PASS empty title rejected with 400

# L17 probe (FT720+, Bearer gate sustain, variant 1)
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"listTodos\",\n    \"operationId\": \"listTodos\",\n    \"statusCode\": 401,\n    \"requestId\": \"9933a3a8b8e16815b43ce9c9a9cf5bf8\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"failure\",\n            \"errorCode\": \"SESSION-CLOSED\",\n            \"errorMessage\": \"Session timeout. Please log in again.\"\n        }\n    }\n}"}],"structuredContent":{"tool":"listTodos","operationId":"listTodos","statusCode":401,"requestId":"9933a3a8b8e16815b43ce9c9a9cf5bf8","body":{"Result":true,"Data":{"status":"failure","errorCode":"SESSION-CLOSED","errorMessage":"Session timeout. Please log in again."}}},"isError":true}}
ADV-PASS listTodos without Bearer returns 401

# L18 probe (FT750+, Bearer read-path hardening, variant 1)
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"createTodo\",\n    \"operationId\": \"createTodo\",\n    \"statusCode\": 401,\n    \"requestId\": \"896300eeafcf971d52211bf4c1ce71ba\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"failure\",\n            \"errorCode\": \"SESSION-CLOSED\",\n            \"errorMessage\": \"Session timeout. Please log in again.\"\n        }\n    }\n}"}],"structuredContent":{"tool":"createTodo","operationId":"createTodo","statusCode":401,"requestId":"896300eeafcf971d52211bf4c1ce71ba","body":{"Result":true,"Data":{"status":"failure","errorCode":"SESSION-CLOSED","errorMessage":"Session timeout. Please log in again."}}},"isError":true}}
...
N/A — security review scheduled for FT771.
...
Automated FT769 (Security review — catalog probes + createTodo invalid Bearer (L18)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT770
