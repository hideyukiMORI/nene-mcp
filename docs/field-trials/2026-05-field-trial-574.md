# Field Trial 574 — Write fail-closed regression + HTTPS TLS CA flag (L12)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 574`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Write fail-closed regression + HTTPS TLS CA flag (L12)**.
...
N/A — security review scheduled for FT576.
...
Automated FT574 (Write fail-closed regression + HTTPS TLS CA flag (L12)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT575
