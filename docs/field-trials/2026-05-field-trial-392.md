# Field Trial 392 — About-only minimal install + SSRF off-host escape (L6)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 392`
...
Automated FT392 (About-only minimal install + SSRF off-host escape (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT393
