# Field Trial 82 — About-only minimal install
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 82`
...
N/A — security review scheduled for FT84.
...
Automated FT82 (About-only minimal install): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT83
