# Field Trial 503 — Misconfiguration adversarial + null tools/call arguments (L9)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 503`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Misconfiguration adversarial + null tools/call arguments (L9)**.
...
Automated FT503 (Misconfiguration adversarial + null tools/call arguments (L9)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT504
