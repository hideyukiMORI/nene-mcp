# Field Trial 511 — Multi-tool read catalog + invalid timeout fallback (L10)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 511`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Multi-tool read catalog + invalid timeout fallback (L10)**.
...
Automated FT511 (Multi-tool read catalog + invalid timeout fallback (L10)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT512
