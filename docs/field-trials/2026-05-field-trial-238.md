# Field Trial 238 — Combined smoke milestone + partial catalog (L4)
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 238`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Combined smoke milestone + partial catalog (L4)**.
...
N/A — security review scheduled for FT240.
...
Automated FT238 (Combined smoke milestone + partial catalog (L4)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT239
