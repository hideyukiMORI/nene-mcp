# Field Trial 129 — Security review — catalog probes
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 129`
...
Automated FT129 (Security review — catalog probes): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT130
