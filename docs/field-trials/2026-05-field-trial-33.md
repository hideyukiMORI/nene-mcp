# Field Trial 33 — Misconfiguration adversarial
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 33`
...
Automated FT33 (Misconfiguration adversarial): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT34
