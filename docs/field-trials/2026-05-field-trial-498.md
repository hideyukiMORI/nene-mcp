# Field Trial 498 — Combined smoke milestone + missing inputSchema catalog (L9)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 498`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Combined smoke milestone + missing inputSchema catalog (L9)**.
...
Automated FT498 (Combined smoke milestone + missing inputSchema catalog (L9)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT499
