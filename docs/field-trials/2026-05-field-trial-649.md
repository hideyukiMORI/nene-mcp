# Field Trial 649 — Security review — catalog probes + Bearer createTodo regression (L14)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 649`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Security review — catalog probes + Bearer createTodo regression (L14)**.
...
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"createTodo\",\n    \"operationId\": \"createTodo\",\n    \"statusCode\": 200,\n    \"requestId\": \"5508fdb8234cece253e5a1ae6d11a42f\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"success\",\n            \"errorCode\": \"\",\n            \"todo\": {\n                \"id\": 56,\n                \"user_id\": 1,\n                \"title\": \"FT630 L14 write\",\n                \"is_completed\": false,\n                \"created_at\": \"2026-05-22 15:51:09\",\n                \"updated_at\": \"2026-05-22 15:51:09\"\n            }\n        }\n    }\n}"}],"structuredContent":{"tool":"createTodo","operationId":"createTodo","statusCode":200,"requestId":"5508fdb8234cece253e5a1ae6d11a42f","body":{"Result":true,"Data":{"status":"success","errorCode":"","todo":{"id":56,"user_id":1,"title":"FT630 L14 write","is_completed":false,"created_at":"2026-05-22 15:51:09","updated_at":"2026-05-22 15:51:09"}}}},"isError":false}}
...
N/A — security review scheduled for FT651.
...
Automated FT649 (Security review — catalog probes + Bearer createTodo regression (L14)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT650
