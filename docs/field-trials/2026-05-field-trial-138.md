# Field Trial 138 — Combined smoke milestone
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 138`
...
Automated FT138 (Combined smoke milestone): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT139
