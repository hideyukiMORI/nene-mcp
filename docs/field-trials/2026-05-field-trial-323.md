# Field Trial 323 — Misconfiguration adversarial + Path param injection (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 323`
...
Automated FT323 (Misconfiguration adversarial + Path param injection (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT324
