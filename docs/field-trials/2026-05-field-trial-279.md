# Field Trial 279 — Security review — catalog probes + Query/base URL confusion (L6)
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 279`
...
Automated FT279 (Security review — catalog probes + Query/base URL confusion (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT280
