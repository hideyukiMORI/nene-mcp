# Field Trial 675 — Catalog edge cases + NENE2 base + Bearer (L15)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 675`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Catalog edge cases + NENE2 base + Bearer (L15)**.
...
{"jsonrpc":"2.0","id":1,"result":{"content":[{"type":"text","text":"{\n    \"tool\": \"getTodoById\",\n    \"operationId\": \"getTodo\",\n    \"statusCode\": 401,\n    \"requestId\": \"ce9711c6fd4d1082b3b6d5d3f7557115\",\n    \"body\": {\n        \"Result\": true,\n        \"Data\": {\n            \"status\": \"failure\",\n            \"errorCode\": \"SESSION-CLOSED\",\n            \"errorMessage\": \"Session timeout. Please log in again.\"\n        }\n    }\n}"}],"structuredContent":{"tool":"getTodoById","operationId":"getTodo","statusCode":401,"requestId":"ce9711c6fd4d1082b3b6d5d3f7557115","body":{"Result":true,"Data":{"status":"failure","errorCode":"SESSION-CLOSED","errorMessage":"Session timeout. Please log in again."}}},"isError":true}}
...
Automated FT675 (Catalog edge cases + NENE2 base + Bearer (L15)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT676
