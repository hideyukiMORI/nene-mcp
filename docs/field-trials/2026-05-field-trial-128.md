# Field Trial 128 — Combined smoke milestone
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 128`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Combined smoke milestone**.
...
N/A — security review scheduled for FT129.
...
Automated FT128 (Combined smoke milestone): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT129
