# Field Trial 569 — Security review — catalog probes + combined operator flags (L11)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 569`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Security review — catalog probes + combined operator flags (L11)**.
...
N/A — security review scheduled for FT570.
...
Automated FT569 (Security review — catalog probes + combined operator flags (L11)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT570
