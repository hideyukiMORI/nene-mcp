# Field Trial 461 — Multi-tool read catalog + invalid JSON-RPC version (L8)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 461`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Multi-tool read catalog + invalid JSON-RPC version (L8)**.
...
N/A — security review scheduled for FT462.
...
Automated FT461 (Multi-tool read catalog + invalid JSON-RPC version (L8)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT462
