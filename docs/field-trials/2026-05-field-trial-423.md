# Field Trial 423 — Misconfiguration adversarial + oversized GET query (L7)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 423`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Misconfiguration adversarial + oversized GET query (L7)**.
...
Automated FT423 (Misconfiguration adversarial + oversized GET query (L7)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT424
