# Field Trial 355 — Catalog edge cases + Path param injection (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 355`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Catalog edge cases + Path param injection (L6)**.
...
Automated FT355 (Catalog edge cases + Path param injection (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT356
