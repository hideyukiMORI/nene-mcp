# Field Trial 328 — Combined smoke milestone + SSRF off-host escape (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 328`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Combined smoke milestone + SSRF off-host escape (L6)**.
...
Automated FT328 (Combined smoke milestone + SSRF off-host escape (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT329
