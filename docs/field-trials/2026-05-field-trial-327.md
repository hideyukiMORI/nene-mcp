# Field Trial 327 — Fresh clone bootstrap + Query/base URL confusion (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 327`
...
Automated FT327 (Fresh clone bootstrap + Query/base URL confusion (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT328
