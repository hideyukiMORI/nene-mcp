# Field Trial 290 — Packagist install regression + JSON-RPC fuzz (L6)
...
- nene-mcp ref: `0.1.4`
- Runner: `tools/ft-individual.sh 290`
...
Automated FT290 (Packagist install regression + JSON-RPC fuzz (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT291
