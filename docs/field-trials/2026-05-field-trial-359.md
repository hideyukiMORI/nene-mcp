# Field Trial 359 — Security review — catalog probes + Query/base URL confusion (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 359`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Security review — catalog probes + Query/base URL confusion (L6)**.
...
N/A — security review scheduled for FT360.
...
Automated FT359 (Security review — catalog probes + Query/base URL confusion (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT360
