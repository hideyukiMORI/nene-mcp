# Field Trial 545 — Catalog edge cases + combined operator flags (L11)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 545`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Catalog edge cases + combined operator flags (L11)**.
...
Automated FT545 (Catalog edge cases + combined operator flags (L11)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT546
