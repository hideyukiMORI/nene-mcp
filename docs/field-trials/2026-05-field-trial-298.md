# Field Trial 298 — Combined smoke milestone + JSON-RPC fuzz (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 298`
...
Automated FT298 (Combined smoke milestone + JSON-RPC fuzz (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT299
