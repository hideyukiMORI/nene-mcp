# Field Trial 198 — Combined smoke milestone
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 198`
...
Automated FT198 (Combined smoke milestone): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT199
