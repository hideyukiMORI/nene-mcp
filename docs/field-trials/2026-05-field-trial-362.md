# Field Trial 362 — About-only minimal install + JSON-RPC fuzz (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 362`
...
N/A — security review scheduled for FT363.
...
Automated FT362 (About-only minimal install + JSON-RPC fuzz (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT363
