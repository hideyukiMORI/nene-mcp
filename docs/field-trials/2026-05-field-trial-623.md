# Field Trial 623 — Misconfiguration adversarial + HTTPS TLS CA fail-fast (L13)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 623`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Misconfiguration adversarial + HTTPS TLS CA fail-fast (L13)**.
...
N/A — security review scheduled for FT624.
...
Automated FT623 (Misconfiguration adversarial + HTTPS TLS CA fail-fast (L13)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT624
