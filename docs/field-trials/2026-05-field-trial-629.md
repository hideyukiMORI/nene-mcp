# Field Trial 629 — Security review — catalog probes + HTTPS TLS CA fail-fast (L13)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 629`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Security review — catalog probes + HTTPS TLS CA fail-fast (L13)**.
...
N/A — security review scheduled for FT630.
...
Automated FT629 (Security review — catalog probes + HTTPS TLS CA fail-fast (L13)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT630
