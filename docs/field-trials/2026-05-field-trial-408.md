# Field Trial 408 — Combined smoke milestone + SSRF off-host escape (L6)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 408`
...
Automated FT408 (Combined smoke milestone + SSRF off-host escape (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT409
