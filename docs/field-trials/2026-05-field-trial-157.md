# Field Trial 157 — Fresh clone bootstrap
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 157`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Fresh clone bootstrap**.
...
Automated FT157 (Fresh clone bootstrap): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT158
