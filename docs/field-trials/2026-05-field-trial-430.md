# Field Trial 430 — Packagist install regression + unicode path param (L7)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 430`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Packagist install regression + unicode path param (L7)**.
...
N/A — security review scheduled for FT432.
...
Automated FT430 (Packagist install regression + unicode path param (L7)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT431
