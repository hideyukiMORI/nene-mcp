# Field Trial 142 — About-only minimal install
...
- nene-mcp ref: `0.1.3`
- Runner: `tools/ft-individual.sh 142`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **About-only minimal install**.
...
N/A — security review scheduled for FT144.
...
Automated FT142 (About-only minimal install): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT143
