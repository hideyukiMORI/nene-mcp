# Field Trial 350 — Packagist install regression + Catalog safety mislabel (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 350`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Packagist install regression + Catalog safety mislabel (L6)**.
...
Automated FT350 (Packagist install regression + Catalog safety mislabel (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT351
