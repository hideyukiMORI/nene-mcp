# Field Trial 347 — Fresh clone bootstrap + Path param injection (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 347`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Fresh clone bootstrap + Path param injection (L6)**.
...
Automated FT347 (Fresh clone bootstrap + Path param injection (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT348
