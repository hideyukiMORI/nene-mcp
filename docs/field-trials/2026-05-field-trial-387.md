# Field Trial 387 — Fresh clone bootstrap + Path param injection (L6)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 387`
...
Automated FT387 (Fresh clone bootstrap + Path param injection (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT388
