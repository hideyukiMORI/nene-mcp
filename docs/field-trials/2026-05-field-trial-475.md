# Field Trial 475 — Catalog edge cases + trailing-space base URL (L8)
...
- nene-mcp ref: `0.1.6`
- Runner: `tools/ft-individual.sh 475`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Catalog edge cases + trailing-space base URL (L8)**.
...
Automated FT475 (Catalog edge cases + trailing-space base URL (L8)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT476
