# Field Trial 299 — Security review — catalog probes + Path param injection (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 299`
...
N/A — security review scheduled for FT300.
...
Automated FT299 (Security review — catalog probes + Path param injection (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT300
