# Field Trial 352 — About-only minimal install + SSRF off-host escape (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 352`
...
N/A — security review scheduled for FT354.
...
Automated FT352 (About-only minimal install + SSRF off-host escape (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT353
