# Field Trial 306 — NeNe Docker golden path smoke + JSON-RPC fuzz (L6)
...
- nene-mcp ref: `0.1.5`
- Runner: `tools/ft-individual.sh 306`
...
Automated FT306 (NeNe Docker golden path smoke + JSON-RPC fuzz (L6)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT307
