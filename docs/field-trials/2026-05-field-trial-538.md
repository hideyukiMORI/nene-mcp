# Field Trial 538 — Combined smoke milestone + TLS CA on http base (L10)
...
- nene-mcp ref: `0.1.8`
- Runner: `tools/ft-individual.sh 538`
- Catalog: `/home/xi/docker/nene-mcp-FT/ft5-nene-multi-read/docs/mcp/tools.json` (when HTTP suites run)
- MCP client: stdio harness

## Goal

Regression + adversarial probe: **Combined smoke milestone + TLS CA on http base (L10)**.
...
Automated FT538 (Combined smoke milestone + TLS CA on http base (L10)): **Pass**.

## Next FT gate

- [ ] No open actionable Issues before FT539
