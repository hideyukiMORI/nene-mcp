...
| File | Use when |
| --- | --- |
| [`mcp-server.md`](mcp-server.md) | Protocol, catalog, HTTP client, bootstrap, env |
| [`docs-policy.md`](docs-policy.md) | Policy docs, workflow, ADRs, README |
| [`release-ci.md`](release-ci.md) | CI, composer scripts, PHP matrix |
