...
NeNe TODO **POST/PUT/DELETE** routes require **`X-CSRF-Token`** from login plus session cookie. nene-mcp does not send CSRF headers. See [NeNe #380](https://github.com/hideyukiMORI/NeNe/issues/380).
